...
const getComments = checkSchema({
  ...
  before: {
    ...
    optional: true,
    isMongoId: {
      errorMessage: 'Invalid commentId format. Please provide a valid MongoDB ObjectId.',
    },
  },
});
...
const postComment = checkSchema({
  ...
  videoId: {
    ...
    isMongoId: {
      errorMessage: 'Invalid videoId format. Please provide a valid MongoDB ObjectId.',
    },
  },
});
